...
class AddCredentialsService:
    ...
    def add_data_source(
        ...
        credentials_details = CredentialsDetails(
            cred_type, encrypted_credentials_string, "Encrypted", privacy_level
        )
        ...
        return self.make_add_datasource_post_request(
            gateway_id, publish_data_source_request_body, access_token
        )
